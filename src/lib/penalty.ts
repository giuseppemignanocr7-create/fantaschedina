...
// 15/09/2026: la scena e' la foto dello stadio (src/assets/arena/stadium.webp,
// 1672x941) ritagliata a 4:3 e centrata: pali a x=315/1360, traversa y=205,
// linea y=545, dischetto (830,770) nell'originale. Palla e tuffo vanno sempre
// nella direzione della zona scelta: fuori e palo restano su quel lato.

/** Riquadro interno della porta nel viewBox. */
export const GOAL = { left: 34, right: 367, top: 65, bottom: 174 } as const;

/** Dischetto del rigore. */
export const SPOT = { x: 198, y: 245 } as const;
