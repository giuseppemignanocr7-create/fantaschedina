...
export function Footer() {
  ...
  return (
    <footer className="bg-dark-800/50 border-t border-slate-200 mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-primary-500 to-accent-500 flex items-center justify-center shadow-lg">
                <span className="text-slate-900 font-bold text-xl">FS</span>
              </div>
              <div>
          ...
          {/* Links */}
          <div>
            <h4 className="font-semibold text-slate-900 mb-4">Navigazione</h4>
            <ul className="space-y-2">
              <li>
                <Link to="/schedina" className="text-slate-500 hover:text-primary-700 transition-colors text-sm flex items-center gap-2">
                  <Trophy size={14} />
                  Gioca Schedina
                </Link>
              </li>
              <li>
                <Link to="/classifica" className="text-slate-500 hover:text-primary-700 transition-colors text-sm flex items-center gap-2">
                  <Trophy size={14} />
                  Classifica
                </Link>
              </li>
              <li>
                <Link to="/regolamento" className="text-slate-500 hover:text-primary-700 transition-colors text-sm flex items-center gap-2">
                  <FileText size={14} />
                  Regolamento
                </Link>
              </li>
          ...
          {/* Contact */}
          <div>
            <h4 className="font-semibold text-slate-900 mb-4">Contatti</h4>
            <ul className="space-y-2">
              <li>
                <a 
                  href="mailto:info@fantaschedina.it" 
                  className="text-slate-500 hover:text-primary-700 transition-colors text-sm flex items-center gap-2"
                >
                  <Mail size={14} />
