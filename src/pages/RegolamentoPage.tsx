...
const sections: Section[] = [
  ...
  },
  {
    ...
    title: 'Calcolo Punti',
    icon: Zap,
    intro: 'I punti di una schedina sono la somma delle quote dei pronostici indovinati. I pronostici sbagliati valgono zero, non tolgono punti.',
    highlight: [
      { label: 'Formula', value: 'Punti = Quota₁ + Quota₂ + … (cap 5.00 a giocata)' },
    ],
    items: [
      { label: '3 corretti a quota 2.00', desc: '→ 6 punti (2+2+2)' },
      { label: '5 corretti a quota 2.00', desc: '→ 10 punti' },
