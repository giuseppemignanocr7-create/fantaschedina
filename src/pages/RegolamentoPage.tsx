...
const sections: Section[] = [
  ...
  },
  {
    ...
    title: 'Calcolo Punti',
    icon: Zap,
    intro: 'I punti di una schedina sono la somma delle quote dei pronostici indovinati, moltiplicata per 10. I pronostici sbagliati valgono zero, non tolgono punti.',
    highlight: [
      { label: 'Formula', value: 'Punti = (Quota₁ + Quota₂ + …) × 10 (cap 5.00 a giocata)' },
    ],
    items: [
      { label: '1 corretto a quota 2.00', desc: '→ 20 punti' },
      { label: '3 corretti a quota 2.00', desc: '→ 60 punti (20+20+20)' },
      { label: '9 corretti su 10', desc: '→ +5 punti di bonus' },
      { label: '10 corretti su 10', desc: '→ +10 punti di bonus' },
      { label: 'Giornata dopo giornata', desc: 'i punti si sommano in classifica generale' },
    ],
  ...
  },
  {
    ...
    title: 'Leghe Private',
    icon: Users,
    intro: 'Ogni lega è una competizione a sé: compili una schedina apposta, con le stesse partite ma punti che valgono solo lì. La schedina della classifica generale resta separata.',
    items: [
      { label: 'Una schedina per lega', desc: 'più quella del circuito generale' },
      { label: 'Copia rapida', desc: 'riporti i pronostici della generale con un tocco' },
      { label: 'Niente gettoni', desc: 'i pronostici di lega non ne fanno guadagnare' },
      { label: 'Power-up', desc: 'si pagano su ogni schedina, anche di lega' },
  ...
  },
  {
    ...
    icon: Award,
    intro: 'I premi sono settimanali: ogni giornata l’amministrazione mette in palio tre premi, assegnati ai primi tre della classifica di quella giornata.',
    items: [
      { label: '1° di giornata', desc: 'Felpa' },
      { label: '2° di giornata', desc: 'T-shirt' },
      { label: '3° di giornata', desc: 'Cappellino' },
      { label: 'Vincitore di giornata', desc: '+100 gettoni, oltre al premio' },
      { label: 'Badge e trofei', desc: 'Riconoscimenti digitali' },
    ],
    content: [
      'I premi di ogni giornata sono decisi dall’amministrazione in base ai partecipanti e sono visibili nella pagina Premi prima della deadline',
