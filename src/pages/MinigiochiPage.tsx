...
const games: Game[] = [
  ...
  },
  {
    emoji: '⚽',
    name: 'RIGORI',
    tagline: 'Freddo dal dischetto?',
    desc: '5 rigori contro il portiere. Spiazzalo e fai bottino.',
    gradient: 'linear-gradient(135deg, #064e2b 0%, #0a7a42 45%, #03301b 100%)',
    glow: '#10b981',
    color: '#34d399',
    cta: 'TIRA!',
    to: '/minigiochi/rigori',
    pts: `+${COINS.rigoriPerGoal} 🪙 a gol`,
  },
  {
    emoji: '⚔️',
    name: 'SFIDE 1vs1',
    tagline: 'Batti il tuo rivale!',
    desc: 'Sfida un avversario ai rigori. Una sfida per coppia ogni settimana.',
    gradient: 'linear-gradient(135deg, #3b0a4e 0%, #5b1a7a 45%, #22052e 100%)',
    glow: '#a855f7',
    color: '#d8b4fe',
    cta: 'SFIDA!',
    to: '/minigiochi/sfide',
