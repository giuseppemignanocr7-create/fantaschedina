  ...
  return (
    <div className="min-h-screen">
      <div className="max-w-2xl mx-auto px-4 py-4 space-y-5">
        ...
        <section className="relative overflow-hidden rounded-2xl border border-primary-500/25 bg-gradient-to-br from-primary-50 via-white to-primary-50 px-5 py-8 text-center">
          ...
          <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-primary-500/15 ring-1 ring-primary-500/30">
            <ShoppingBag size={26} className="text-primary-700" strokeWidth={1.8} />
          </div>

          <span className="inline-flex items-center gap-1.5 rounded-full border border-primary-500/30 bg-primary-500/10 px-3 py-1 text-[10px] font-black uppercase tracking-widest text-primary-800">
            <Clock size={11} strokeWidth={2.5} />
            Prossimamente
          </span>

          <h2 className="mt-3 font-display text-2xl font-black tracking-tight text-slate-900">
        ...
        <section
          ...
          className="overflow-hidden rounded-2xl border border-slate-200 bg-white/[0.03]"
        >
          ...
          <div className="flex items-start gap-3 p-4">
            <Shirt size={18} className="mt-0.5 flex-shrink-0 text-primary-700" strokeWidth={2} />
            <div>
              <h3 id="maglia-titolo" className="font-display text-base font-black text-slate-900">
                Maglia da Gara
              </h3>
        ...
        <section aria-labelledby="anteprima-titolo" className="space-y-5">
          <div className="flex items-center gap-2">
            <Sparkles size={15} className="text-primary-700" strokeWidth={2} />
            <h3
              id="anteprima-titolo"
            ...
            <div key={group.category} className="space-y-2">
              ...
              <ul className="grid grid-cols-2 gap-2 sm:grid-cols-3">
                {group.items.map(item => (
                  <li
                    key={item.name}
                    className="overflow-hidden rounded-xl border border-slate-200 bg-white/[0.03]"
                  >
                    ...
                    <div className="p-2.5">
                      <p className="text-[12px] font-bold leading-tight text-slate-500">
                        {item.name}
                      </p>
